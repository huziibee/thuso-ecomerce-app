...
export default function UpdatePasswordForm() {
  ...
  return (
    <form action={dispatch}>
      <div className="rounded-md bg-gray-100 dark:bg-gray-900 p-4 md:p-6">
        <div className="mb-4">
          <label htmlFor="current_password" className="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-100">
            Current Password
          </label>
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                required
                minLength={6}
                className="peer block w-full rounded-md border border-gray-300 dark:border-gray-600 py-2 pl-10 text-sm text-gray-900 dark:text-gray-100 bg-gray-200 dark:bg-gray-800 outline-2 placeholder:text-gray-500 dark:placeholder:text-gray-400"
              />
        ...
        <div className="mb-4">
          <label htmlFor="new_password" className="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-100">
            New Password
          </label>
          <div className="relative mt-2 rounded-md">
            <div className="relative">
