          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                className="peer block w-full rounded-md border text-gray-900 dark:text-gray-100 bg-gray-200 dark:bg-gray-800 border-gray-300 dark:border-gray-600 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500 dark:placeholder:text-gray-400"
              />
